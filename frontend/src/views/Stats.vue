...
export default {
  name: 'Stats',
  components: { StatYearly, StatChurch, StatArea, StatVolt, StatActs, StatOthers, StatLeaders, StatDistrict, FloatButton },
  computed: {
    targetComponents () {
      return ['StatArea', 'StatDistrict', 'StatYearly', 'StatChurch', 'StatVolt', 'StatActs', 'StatOthers', 'StatLeaders']
    }
  },
  data: () => ({
    tabIdx: 0,
